    ...
    >
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-red-500 to-rose-200 bg-clip-text text-transparent leading-right">
            Hi, I'm Kalil Rahman;
          </h1>

          <p className="tex-gray-400 text-lg mb-8 max-w-lg mx-auto">
            I’m a full-stack developer passionate about building clean,
             scalable, and user-focused web applications. I love turning ideas 
             into seamless digital experiences that blend high performance with intuitive design.
          </p>
